...
{
    // Provide static APIs to retrieve Right/Left or other controller's
    // device index. Same assigning logic as SteamVR_ControllerManager provided.
    public static class ViveRole
    {
        public const int DEVICE_ROLE_COUNT = 16;
        public const int HAND_ROLE_COUNT = 2;
